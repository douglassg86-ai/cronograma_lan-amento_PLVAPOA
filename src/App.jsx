...
const INITIAL_COLUMNS = [
  { id: 'c1', title: '16 - 22/4', highlighted: false },
  { id: 'c2', title: '23 - 29/4', highlighted: false },
  { id: 'c3', title: '30/4 - 6/5', highlighted: false },
  { id: 'c4', title: '7 - 14/5', highlighted: false },
  { id: 'c5', title: '15 - 20/5', highlighted: false },
  { id: 'c6', title: '21 - 27/5', highlighted: false },
  { id: 'c7', title: '28/5 a 3/6', highlighted: false },
  { id: 'c8', title: '4 - 10/6', highlighted: false },
  { id: 'c9', title: '10 - 16/6 DIA D', highlighted: false },
];
...
const INITIAL_CARDS = {
  "f-00": {
    "c1": [{ id: "id1", type: "numeric", value: 4000, color: "pink" }],
    "c2": [{ id: "id2", type: "numeric", value: 15000, color: "pink" }],
    "c3": [{ id: "id3", type: "numeric", value: 4000, color: "pink" }],
    "c4": [{ id: "id4", type: "numeric", value: 15000, color: "pink" }],
    "c5": [{ id: "id5", type: "numeric", value: 4000, color: "pink" }]
  },
  "f-01": {
    "c1": [{ id: "id6", type: "numeric", value: 27, color: "yellow" }],
    "c2": [{ id: "id7", type: "numeric", value: 27, color: "yellow" }],
    "c3": [{ id: "id8", type: "numeric", value: 27, color: "yellow" }],
    "c4": [{ id: "id9", type: "numeric", value: 27, color: "yellow" }],
    "c5": [{ id: "id10", type: "numeric", value: 27, color: "yellow" }],
    "c6": [{ id: "id11", type: "numeric", value: 27, color: "yellow" }],
    "c7": [{ id: "id12", type: "numeric", value: 27, color: "yellow" }],
    "c8": [{ id: "id13", type: "numeric", value: 27, color: "yellow" }]
  },
  "f-02": {
    "c1": [{ id: "id14", type: "numeric", value: 1000, color: "cyan" }],
    "c2": [{ id: "id15", type: "numeric", value: 1000, color: "cyan" }],
    "c3": [{ id: "id16", type: "numeric", value: 1000, color: "cyan" }],
    "c4": [{ id: "id17", type: "numeric", value: 1000, color: "cyan" }],
    "c5": [{ id: "id18", type: "numeric", value: 1000, color: "cyan" }],
    "c6": [{ id: "id19", type: "numeric", value: 1000, color: "cyan" }]
  },
  "f-03": {
    "c1": [{ id: "id20", type: "numeric", value: 63, color: "yellow" }],
    "c2": [{ id: "id21", type: "numeric", value: 63, color: "yellow" }],
    "c3": [{ id: "id22", type: "numeric", value: 20, color: "yellow" }],
    "c4": [{ id: "id23", type: "numeric", value: 20, color: "yellow" }],
    "c5": [{ id: "id24", type: "numeric", value: 20, color: "yellow" }],
    "c6": [{ id: "id25", type: "numeric", value: 20, color: "yellow" }]
  },
  "f-04": {
    "c1": [{ id: "id26", type: "numeric", value: 4, color: "pink" }, { id: "id27", type: "numeric", value: 23, color: "cyan" }],
    "c2": [{ id: "id28", type: "numeric", value: 4, color: "pink" }, { id: "id29", type: "numeric", value: 22, color: "cyan" }],
    "c3": [{ id: "id30", type: "numeric", value: 4, color: "pink" }, { id: "id31", type: "numeric", value: 23, color: "cyan" }],
    "c4": [{ id: "id32", type: "numeric", value: 4, color: "pink" }, { id: "id33", type: "numeric", value: 22, color: "cyan" }],
    "c5": [{ id: "id34", type: "numeric", value: 4, color: "pink" }, { id: "id35", type: "numeric", value: 23, color: "cyan" }],
    "c6": [{ id: "id36", type: "numeric", value: 4, color: "pink" }, { id: "id37", type: "numeric", value: 22, color: "cyan" }],
    "c7": [{ id: "id38", type: "numeric", value: 4, color: "pink" }, { id: "id39", type: "numeric", value: 23, color: "cyan" }],
    "c8": [{ id: "id40", type: "numeric", value: 4, color: "pink" }, { id: "id41", type: "numeric", value: 22, color: "cyan" }]
  },
  "f-05": {
    "c1": [{ id: "id42", type: "numeric", value: 2, color: "pink" }, { id: "id43", type: "numeric", value: 13, color: "cyan" }],
    "c2": [{ id: "id44", type: "numeric", value: 2, color: "pink" }, { id: "id45", type: "numeric", value: 14, color: "cyan" }],
    "c3": [{ id: "id46", type: "numeric", value: 2, color: "pink" }, { id: "id47", type: "numeric", value: 13, color: "cyan" }],
    "c4": [{ id: "id48", type: "numeric", value: 2, color: "pink" }, { id: "id49", type: "numeric", value: 14, color: "cyan" }],
    "c5": [{ id: "id50", type: "numeric", value: 2, color: "pink" }, { id: "id51", type: "numeric", value: 13, color: "cyan" }],
    "c6": [{ id: "id52", type: "numeric", value: 2, color: "pink" }, { id: "id53", type: "numeric", value: 14, color: "cyan" }],
    "c7": [{ id: "id54", type: "numeric", value: 2, color: "pink" }, { id: "id55", type: "numeric", value: 13, color: "cyan" }],
    "c8": [{ id: "id56", type: "numeric", value: 2, color: "pink" }, { id: "id57", type: "numeric", value: 14, color: "cyan" }]
  },
  "f-06": {
    "c1": [{ id: "id58", type: "numeric", value: 1, color: "cyan" }],
    "c2": [{ id: "id59", type: "numeric", value: 1, color: "pink" }, { id: "id60", type: "numeric", value: 2, color: "cyan" }],
    "c3": [{ id: "id61", type: "numeric", value: 1, color: "cyan" }],
    "c4": [{ id: "id62", type: "numeric", value: 1, color: "pink" }, { id: "id63", type: "numeric", value: 2, color: "cyan" }],
    "c5": [{ id: "id64", type: "numeric", value: 1, color: "cyan" }],
    "c6": [{ id: "id65", type: "numeric", value: 1, color: "pink" }, { id: "id66", type: "numeric", value: 2, color: "cyan" }],
    "c7": [{ id: "id67", type: "numeric", value: 1, color: "cyan" }],
    "c8": [{ id: "id68", type: "numeric", value: 2, color: "pink" }, { id: "id69", type: "numeric", value: 2, color: "cyan" }]
  },
  "mkt-1": {
    "c1": [
      { id: "m1_1", type: "text", value: "Folder" },
      { id: "m1_2", type: "text", value: "Carta a longo" },
      { id: "m1_3", type: "text", value: "Reunião GP" }
    ],
    "c2": [
      { id: "m2_1", type: "text", value: "Disparo Localiza GP" },
      { id: "m2_2", type: "text", value: "Validação" }
    ],
    "c3": [
      { id: "m3_1", type: "text", value: "Disparo Técnico" },
      { id: "m3_2", type: "text", value: "Plantão Flex" }
    ],
    "c4": [
      { id: "m4_1", type: "text", value: "Evento W3GN" },
      { id: "m4_2", type: "text", value: "LP Projeto" },
      { id: "m4_3", type: "text", value: "Brindes" }
    ],
    "c5": [
      { id: "m5_1", type: "text", value: "Sacada" }
    ],
    "c7": [
      { id: "m6_1", type: "text", value: "Áreas Condominiais" }
    ],
    "c8": [
      { id: "m7_1", type: "text", value: "Teaser Decorado" },
      { id: "m7_2", type: "text", value: "Infraestrutura" }
    ],
    "c9": [
      { id: "m8_1", type: "text", value: "Conheça o apartam. decorado" },
      { id: "m8_2", type: "text", value: "Dia D" }
    ]
  },
  "int-1": {
    "c1": [
      { id: "i1_1", type: "text", value: "Início atendim." },
      { id: "i1_2", type: "text", value: "Falar 3 imobiliárias" }
    ],
    "c2": [
      { id: "i2_1", type: "text", value: "Abordar 10 pessoas" },
      { id: "i2_2", type: "text", value: "Distrib. vagas" }
    ],
    "c3": [
      { id: "i3_1", type: "text", value: "Treinamento imobiliárias" },
      { id: "i3_2", type: "text", value: "Falar sobre prod." }
    ],
    "c4": [
      { id: "i4_1", type: "text", value: "Treinamento" },
      { id: "i4_2", type: "text", value: "Convidar imob." },
      { id: "i4_3", type: "text", value: "Falar do evento" }
    ],
    "c5": [
      { id: "i5_1", type: "text", value: "Treinamento imobiliárias" }
    ],
    "c6": [
      { id: "i6_1", type: "text", value: "Treinamento imobiliárias" }
    ],
    "c7": [
      { id: "i7_1", type: "text", value: "Treinamento imobiliárias" }
    ]
  }
};
...
export default function App() {
  ...
  useEffect(() => {
    ...
    signInAnonymously(auth).catch(error => console.error("Erro no Auth:", error));
  ...
  useEffect(() => {
    if (!user) return;
    if (firebaseConfig.apiKey === "SUA_API_KEY") {
      // Modo demonstração local, não tenta conectar ao Firestore
      setCards(INITIAL_CARDS);
      setIsLoading(false);
      return;
    }
    
    const docRef = doc(db, 'scheduleData', 'main');
    ...
    const unsubscribe = onSnapshot(docRef, (snapshot) => {
      if (snapshot.exists()) {
        ...
        // Salva os dados do quadro físico no Firebase no primeiro carregamento
        setDoc(docRef, { columns: INITIAL_COLUMNS, cards: INITIAL_CARDS });
        setCards(INITIAL_CARDS);
      }
      setIsLoading(false);
    }, (error) => {
  ...
  const syncData = async (newColumns, newCards) => {
    if (!user || firebaseConfig.apiKey === "SUA_API_KEY") return;
    const docRef = doc(db, 'scheduleData', 'main');
    await setDoc(docRef, { columns: newColumns, cards: newCards }, { merge: true });
  };

  const addColumn = () => {
    const title = prompt('Digite o título da nova semana (ex: 26/ago - 30/ago):');
    if (title) {
      const newCols = [...columns, { id: `c${Date.now()}`, title, highlighted: false }];
      setColumns(newCols);
      syncData(newCols, cards);
    }
  };

  const editColumn = (colId, currentTitle) => {
    const newTitle = prompt('Editar título da semana:', currentTitle);
    if (newTitle) {
  ...
  const getRowTotals = (rowId) => {
    ...
    Object.values(rowData).forEach(colCards => {
      colCards.forEach(card => {
        if (card.type === 'numeric' && card.color) {
  ...
  const getHighlightClasses = (colIndex, isHeader = false, isLastRow = false) => {
    ...
    let classes = 'bg-red-50/50 transition-colors ';
                    ...
                    <div className="flex items-center justify-between group">
                      ...
                      {!highlightMode && (
                        <div className="flex gap-1 opacity-100 md:opacity-0 group-hover:opacity-100 transition-opacity">
                          <button onClick={(e) => { e.stopPropagation(); editColumn(col.id, col.title); }} className="p-1 text-slate-400 hover:text-indigo-600 rounded">
                            <Edit2 size={14} />
                          </button>
                    ...
                    {columns.map((col, colIdx) => {
                      ...
                      return (
                        <td 
                          ...
                          className={`border-r border-b border-slate-200 p-2 align-top min-h-[80px] cursor-pointer transition-colors hover:bg-slate-50 ${getHighlightClasses(colIdx, false, isLastRow)}`}
                        >
                          <div className="flex flex-wrap gap-2">
                            {cellCards.map(card => (
                              <div 
                                key={card.id} 
                                className={`relative group/card flex items-center justify-center px-3 py-1.5 rounded-md border text-xs md:text-sm font-medium shadow-sm w-full ${
                                  card.type === 'numeric' 
